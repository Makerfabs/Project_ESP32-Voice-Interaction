...
void stateshow(int i)
{
    ...
    display.setCursor(0,20);             // Start at top-left corner
    switch(i) {
      case 1: display.println(F("Recording...")); break;
      case 2: display.println(F("Recording completed")); break;
      case 3: display.println(F("Playing...")); break;      
    }    
    display.display();
    delay(20);
}
